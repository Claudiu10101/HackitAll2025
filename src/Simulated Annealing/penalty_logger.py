...
class PenaltyLogger:
    ...
    def reset(self) -> None:
        ...
        self.by_day: Dict[int, Dict[str, float]] = defaultdict(
    ...
    def write_reports(self) -> None:
        ...
        # CSV per day
        all_codes = sorted(
            {code for day in self.by_day.values() for code in day.keys()}
        )
        ...
        # Totals CSV
        total_rows = [["code", "total_penalty"]] + [
            [code, self.totals.get(code, 0.0)] for code in all_codes
        ]
